...
class FamHomeScreen extends StatelessWidget {
  final List<Map<String, dynamic>> items = [
    {
      'title': 'البرامج',
      'route': AppRouter.familyhome,
      'icon': LucideIcons.calendar
    },
    {'title': 'رمضان', 'route': AppRouter.praytime, 'icon': LucideIcons.moon},
    {
      'title': 'المسابقات',
      'route': AppRouter.famQuizes,
      'icon': LucideIcons.trophy
    },
    {'title': 'عام', 'route': AppRouter.familyhome, 'icon': LucideIcons.grid},
  ];
